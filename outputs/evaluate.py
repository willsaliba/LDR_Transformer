...
def main(
    model_dir: Path = Path("/Users/willsaliba/Documents/code/uni/advTopics/models/OMR8_ENG"), 
    tokenizer_path: Path = Path("/Users/willsaliba/Documents/code/uni/advTopics/tokenizers/"), 
    test_files_path: Path = Path("/Users/willsaliba/Documents/code/uni/advTopics/data/omr8_clean/eval_set"), 
    csv_filename: str = "outputs/scores/OMR8_ENG.csv",
    ...
    for file_path in itertools.islice(test_files_path.glob("*.mpd"), num_test_files+100):
        ...
        if len(all_results) % 50 == 0 and len(all_results) != 0: print(f"\n---Evaluated: {len(all_results)} ---\n")
...
#print(f"Ave Shape-Color Set Accuracy: {avg_shape_color_set_acc:.2f}\n")